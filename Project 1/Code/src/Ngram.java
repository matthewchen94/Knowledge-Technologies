...
{
	/* 
	 * This class implements the N-Gram Distance approximate matching method on
	 * each word in the misspell.txt with each word in the dictionary.txt and 
	 * returns a distance in the form of double.
	 * 
	 * Source of this method: https://itssmee.wordpress.com/2010/06/28/java-example-of-n-gram/
	 */
